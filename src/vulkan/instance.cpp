...
Instance::Instance(const app::Window& appWindow) : _appWindow(appWindow) {
...
Instance::SwapchainParts Instance::_createSwapChain() {
...
VkDescriptorSetLayout Instance::_createDescriptorSetLayout() {
...
std::vector<VkDescriptorSet> Instance::_createDescriptorSets() {
...
std::vector<VkImageView> Instance::_createImageViews() {
...
Instance::PipelineParts Instance::_createGraphicsPipeline() {
...
VkRenderPass Instance::_createRenderPass() {
...
std::vector<VkFramebuffer> Instance::_createFramebuffers() {
...
std::vector<VkCommandBuffer> Instance::_createCommandBuffers() {
...
Instance::Buffer Instance::_createVertexBuffer() {
    return _createTwoLevelBuffer(_scene.vertices,
                                 VK_BUFFER_USAGE_VERTEX_BUFFER_BIT);
}

Instance::Buffer Instance::_createIndexBuffer() {
    return _createTwoLevelBuffer(_scene.indices,
                                 VK_BUFFER_USAGE_INDEX_BUFFER_BIT);
}

std::vector<Instance::Buffer> Instance::_createUniformBuffers() {
...
VkDescriptorPool Instance::_createDescriptorPool() {
...
Instance::Buffer Instance::_createBuffer(VkDeviceSize size,
...
void Instance::Buffer::destroy(VmaAllocator allocator) {
